...
int main(int argc, char **argv) {
	...
	/*
	*For serial mergesort uncomment -> serial_mergesort(A,1,n);
	* and comment parallel_mergesort(A, 1, n, threads);
	*For parallel mergesort uncomment -> parallel_mergesort(A, 1, n, threads);
	* and comment serial_mergesort(A,1,n)
	*/
